...
\startTEXpage
  \starttikzpicture[->,>=latex']
    \matrix[row sep={10mm,between origins},%
     ...
     \node[dynamics] (rho2) [label=right:{$ρ_2$}]     {}; \\
     % Third row
     \node[condition]  (x1)    [label=left:{$x_1$}]     {}; &
     \node[obs]  (u11)   [label=left:{$u_{1,1}$}] {}; &
     \node[data]    (u21)   [label=left:{$u_{2,1}$}] {}; &
     \node[condition]  (x2)    [label=left:{$x_2$}]     {}; &
     \node[obs]  (u12)   [label=left:{$u_{1,2}$}] {}; &
     \node[condition]  (u22)   [label=left:{$u_{2,2}$}] {}; \\
                                                      & & 
     \node[control] (g21)   [label=right:{$g_{2,1}$}] {}; &
                                                      & & 
     \node[choice] (g22)   [label=right:{$g_{2,2}$}] {}; \\
    } ;
...
\startTEXpage
  \starttikzpicture[->,>=latex']
    ...
    \path (u11) edge (g12) ;
    %\path (u21) edge (g22) ;
    \path[color=darkgreen, thick] (u11) edge (g22) ;
    \path[color=darkgreen, thick] (u12) edge (g22) ;
...
\startTEXpage
  \starttikzpicture[->,>=latex']
    \matrix[row sep={10mm,between origins},%
     ...
     \node[dynamics] (rho1) [label=right:{$ρ_1$}]     {}; &
     \node[dynamics] (f1)   [label=right:{$f_1$}]     {}; &
     \node[choice]  (g12)  [label=right:{$g_{1,2}$}] {}; &
     \node[dynamics] (rho2) [label=right:{$ρ_2$}]     {}; \\
     % Third row
     \node[condition]  (x1)    [label=left:{$x_1$}]     {}; &
     \node[condition]  (u11)   [label=left:{$u_{1,1}$}] {}; &
     \node[obs]  (u21)   [label=left:{$u_{2,1}$}] {}; &
     \node[condition]  (x2)    [label=left:{$x_2$}]     {}; &
     \node[condition]  (u12)   [label=left:{$u_{1,2}$}] {}; &
     \node[normal]  (u22)   [label=left:{$u_{2,2}$}] {}; \\
                                                      & & 
     \node[control] (g21)   [label=right:{$g_{2,1}$}] {}; &
                                                      & & 
...
\startTEXpage
  \starttikzpicture[->,>=latex']
    ...
    \path (u11) edge (g22) ;
    \path (u12) edge (g22) ;
    \path[color=darkgreen, thick] (u21) edge (g12) ;
...
\startTEXpage
  \starttikzpicture[->,>=latex']
    \matrix[row sep={10mm,between origins},%
            column sep={15mm,between origins}] {
                                                & & 
     \node[rewarded] (r1) [label=left:{$r_1$}] {} ; &
                                                & & 
     \node[rewarded] (r2) [label=left:{$r_2$}] {} ; \\
     % Second row
     \node[dynamics] (f0)   [label=right:{$f_0$}]     {}; &
     ...
     \node[normal]  (u22)   [label=left:{$u_{2,2}$}] {}; \\
                                                      & & 
     \node[choice] (g21)   [label=right:{$g_{2,1}$}] {}; &
                                                      & & 
     \node[control] (g22)   [label=right:{$g_{2,2}$}] {}; \\
    } ;
...
\startTEXpage
  \starttikzpicture[->,>=latex']
    ...
    \path (u12) edge (g22) ;
    \path (u21) edge (g12) ;
    \path[color=darkgreen, thick] (u11) edge (g21) ;
...
\startTEXpage
  \starttikzpicture[->,>=latex']
    \matrix[row sep={10mm,between origins},%
     ...
     \node[data]  (u11)   [label=left:{$u_{1,1}$}] {}; &
     \node[obs]  (u21)   [label=left:{$u_{2,1}$}] {}; &
     \node[condition]  (x2)    [label=left:{$x_2$}]     {}; &
     \node[condition]  (u12)   [label=left:{$u_{1,2}$}] {}; &
     \node[condition]  (u22)   [label=left:{$u_{2,2}$}] {}; \\
...
\startTEXpage
  \starttikzpicture[->,>=latex']
    ...
    \path (u11) edge (g12) ;
    \path[color=darkgreen, thick] (u21) edge (g22) ;
    %\path (u11) edge (g22) ;
    \path (u12) edge (g22) ;
    \path (u21) edge (g12) ;
    \path (u11) edge (g21) ;
...
\startTEXpage
  \starttikzpicture[->,>=latex']
    \matrix[row sep={10mm,between origins},%
     ...
     \node[data]  (x1)    [label=left:{$x_1$}]     {}; &
     \node[data]  (u11)   [label=left:{$u_{1,1}$}] {}; &
     \node[condition]  (u21)   [label=left:{$u_{2,1}$}] {}; &
     \node[condition]  (x2)    [label=left:{$x_2$}]     {}; &
     \node[condition]  (u12)   [label=left:{$u_{1,2}$}] {}; &
     \node[normal]  (u22)   [label=left:{$u_{2,2}$}] {}; \\
                                                      & & 
