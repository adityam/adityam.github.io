...
- **ECSE 303: Signals and Systems I** <br />
...
- **ECSE 506: Stochastic control and decision theory** 
  ([website](stochastic-control)) 
  <br />
  Winter 2012 to present (every even year)

- **ECSE 508: Multi-agent systems** 
  ([website](multi-agent-systems)) 
 <br />
  Winter 2011 to present (every odd year)

- **ECSE 509: Probability and Random Signals** 
  ([website](probability-and-random-signals)) 
  <br />
  Fall 2022 to present.

## Summer Courses

- **CNI Summer School 2026: Model approximation in MDPs and POMDPs**
  ([website](AIS-course))
  <br />
  Summer 2026.
